...
const Mobility = () => {
    ...
    return(
        <section className={"w-full flex flex-col justify-center items-center"}>
            ...
            <div id={"trip-introduction"} className={sectionClass}>
                <div className={"mb-16"}>
            ...
            <div id={"trip-experiences"} className={sectionClass}>
                <div className={"mb-16"}>
                    <h2 className={subTitleClass}>Turin, Italie : 22/11/2021 - 20/12/2021</h2>
                    <div>
                ...
                <div className={"mb-16"}>
                    <h2 className={subTitleClass}>Piano di Sorrento, Italie : 26/12/2021 - 10/01/2022</h2>
                    <div>
                ...
                <div className={"mb-16"}>
                    <h2 className={subTitleClass}>Agio Nikolaos, Grèce : 30/01/2022 - 14/02/2022</h2>
                    <div>
                ...
                <div className={"mb-16"}>
                    <h2 className={subTitleClass}>Königsdorf, Autriche : 04/03/2022 - 30/03/2022</h2>
                    <div>
            ...
            <div id={"trip-conclusion"} className={sectionClass + " mb-16"}>
